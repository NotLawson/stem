...
class LineFollowerSensors:
    ...
    def left(self):
        ...
        if reflected_light in range(19, 25): # dark green (22%)
            return "green"
        elif reflected_light in range(0, 18): # black (0%)
            return "black"
    ...
    def right(self):
        ...
        if reflected_light in range(19, 25): # dark green (22%)
            return "green"
        elif reflected_light in range(0, 20): # black (0%)
            return "black"
        elif reflected_light in range(70, 100): # white (100%)
            return "white"
